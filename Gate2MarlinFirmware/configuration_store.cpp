...
//typedef struct PIDC { float Kp, Ki, Kd, Kc; } PIDC; // by Bartek
...
typedef struct SettingsDataStruct {
  ...
  // PIDTEMP
  //
//  PIDC hotendPID[MAX_EXTRUDERS];                        // M301 En PIDC / M303 En U by Bartek
  ...
  // PIDTEMPBED
  //
//  PID bedPID;                                           // M304 PID / M303 E-1 U  by Bartek
