...
*/
  ...
  #error "Oops!  Make sure you have 'Teensy++ 2.0', 'MattairTech MT-DB-U6' or 'Printrboard' selected from the 'Tools -> Boards' menu."
#endif

#define DEFAULT_MACHINE_NAME    "3Novatica Gate 2.0"
#define DEFAULT_SOURCE_CODE_URL "https://github.com/bartoszrajewski/Gate2Marlin"
#define BOARD_NAME              "3Novatica Gate 2.0"

//
// Limit Switches
//
#define X_STOP_PIN          27
...
#define Z2_STEP_PIN        14
#define Z2_DIR_PIN         13
#define Z2_ENABLE_PIN      11
...
#define LCD_PINS_RS      1   // E0
#define LCD_PINS_ENABLE  3   // E1
#define LCD_PINS_D4      0   // C0
#define LCD_PINS_D5      2   // C1
#define LCD_PINS_D6      4   // C2
#define LCD_PINS_D7      6   // C3
#define BTN_EN1          -1  // F0
#define BTN_EN2          -1  // F1
#define BTN_ENC          -1  // F2
#endif
...
//
#define SPINDLE_LASER_ENABLE_PIN  -1   // D5  Pin should have a pullup!
#define SPINDLE_LASER_PWM_PIN     -1   // D0 PWM0B   MUST BE HARDWARE PWM
#define SPINDLE_DIR_PIN           -1   // D7
